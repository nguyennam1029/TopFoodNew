      ...
      <div class="row">
        <div class="col-9 col-md-8 col-sm-12">
          <div class="content-left">
              ...
              <div class="container">
                <div class="header-list-product">
                  <div class="section-header" style="margin-bottom: 0;">
                    <h2 class="booton-text">Các loại sản phẩm</h2>
                  ...
                  <div class="row">
                    ...
                    <?php foreach ($result as $row) : ?>
                      <div class="tab-item--product col-3 col-md-4 col-sm-4" data-item="<?php echo $row["namensx"] ?>">
                        <a href="./product_detail.php?id=<?php echo $result['id'] ?>" class="product-item">
            ...
            <div id="no-product" style="display: none ; align-items: center; justify-content: center;">
              <img src="https://xe2banh.com.vn/img/no-products.png" alt="">

              ...
              <div class="cart-right">
                <div class="cart-right-top">
                  <div class="cart-right-top--info">
                    <h5 class="cart-right-top--name">Thịt sường hun khói</h5>
                    <span class="cart-right-top--price">189.000<sup>đ</sup></span>
                  </div>
                  <span class="cart-right-top--total">189.000 đ</span>
                </div>
                <div class="cart-right-bottom">
                  <div class="cart-right-bottom--quantity">
                    <a href="#" class="cart-right--link">-</a>
                    <span class="cart-right--link cart-right--quantity">1</span>
                    <a href="#" class="cart-right--link">+</a>
                  </div>
                  <div class="cart-right-bottom--btn">
                    <a href="#" class="cart-right-bottom--delete">
                      <i class='bx bx-trash'></i>
                      <span>Xóa</span>
                    </a>
                    <div class="cart-right-bottom--save">

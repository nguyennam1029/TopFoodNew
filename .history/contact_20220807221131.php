...
<body>
    ...
    <div class="app">
        ...
        <div class="wrapper-contact">
            <?php if (!isset($GET['noti'])) { ?>
                <div class="noti">
                    <div class="noti-content">
                        <i class='bx bxs-bell-ring'></i>
                        <span class="noti-title">Cảm ơn bạn đã đóng góp ý kiến</span>
                    ...
                    <div class="col-6 col-o-3 col-md-6 col-md-o-0 col-sm-12">
                        <div class="contact" style="padding: 0;">
                            <form action="process/process_contact.php" method="POST">
                                ...
                                <input class="contact-input" type="text" placeholder="Phone" name="phone">
                                <textarea class="contact-input textarea" rows="10" cols="50" name="message" placeholder="Message"></textarea>
                                <div class="contact-sub">
                                    <button class="custom-btn btn-11 hover-active contact-sub" style="width: 120px;">
                                        Gửi
                                    </button>

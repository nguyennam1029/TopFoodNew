...
<body>
  <div class="app">
                  ...
                  <div class="cart-right">
                    ...
                    <div class="cart-right-bottom">
                      <div class="cart-right-bottom--quantity">
                        <a href="./process/update_cart.php?id=<?php echo $id ?>&type=decre" class=" cart-right--link">-</a>
                        <span class="cart-right--link cart-right--quantity"><?php echo $cart_item['quantity'] ?></span>
                        <a href="./process/update_cart.php?id=<?php echo $id ?>&type=incre" class="cart-right--link">+</a>
                      </div>
                      <div class="cart-right-bottom--btn">
                        ...
                        <a href="./process/delete_cart_item.php?id=<?php echo $id ?>" class="cart-right-bottom--delete">
    ...
    padding-right: 15px;">
      ...
      <div class="container container-width">
        ...
        ?>
        <div class="section-header" style="margin-top: 40px;">
          <p class="booton-text">Thông tin đặt hàng</p>
        </div>
        <div class="formby">
          <form method="post" action="./process/process_checkout.php">
            <div class="formby-item">
              <span>Họ và tên</span>
              <input type="text" name="name_receiver" value='<?php echo $each['name'] ?>'>
            </div>
            <div class="formby-item">
              <span>Số điện thoại</span>
              <input type="number" name="phone_receiver" value='<?php echo $each['phone'] ?>'>
            </div>
            <div class="formby-item">
              <span>Địa chỉ</span>
            ...
            <button class="formby-btn custom-btn btn-11 hover-active">Đặt hàng</button>
          </form>
        </div>
      </div>
    </div>
  ...
  <script>
    ...
    console.log("cartItem", cartItem, notiTextCount);
    for (let i = 0; i < cartItem.length; i++) {
      notiTextCount.textContent = i + 1;
    }
  </script>
</body>

          ...
          <div class="content-left">
            ...
            <div class="row reverse-mover" style="margin-top: 20px">
              ...
              <div class="col-3 col-md-4 col-sm-6">
                <a href="../detail/tinh_hai_kysi.html" class="action-item">
                  <div class="action-img">
                    <img src="../images/cartoons/Tinh-Hai-Ky-Si.webp" alt="TINH LINH HUYỄN TƯỞNG KÝ" />
                  </div>
              ...
              <div class="col-3 col-md-4 col-sm-6">
                <a href="#" class="action-item">
                  <div class="action-img">
                    <img src="https://tvhai.co/wp-content/uploads/2022/03/spl-tvhayorg-25889-250x350.jpg" alt="Sát thủ 567 phần 3" />
                  </div>
              ...
              <div class="col-3 col-md-4 col-sm-6">
                <a href="#" class="action-item">
                  <div class="action-img">
                    <img src="../images/movies/haihuoc3.jpg" alt="Chân võ đỉnh phong" />
                  </div>
              ...
              <div class="col-3 col-md-4 col-sm-6">
                <a href="../detail/tinh_than_bien.html" class="action-item">
                  <div class="action-img">
                    <img src="../images/cartoons/Tinh-Than-Bien-4.webp" alt="TINH LINH HUYỄN TƯỞNG KÝ" />
                  </div>
        ...
        <div class="container">
          ...
          <div class="showtime">
            <div class="tab-list">
              ...
              <div class="tab-item" data-tab="6">Thứ 7</div>
              <div class="tab-item" data-tab="7">Chủ nhật</div>
            </div>
          </div>
          <!-- ----THỨ 2----- -->

          ...
          <div class="content-left">
            ...
            <div class="section">
              <div class="container">
                ...
                <div class="showtime">
                  <div class="tab-list">
                    <div class="tab-item is-active" data-tab="1">All</div>
                    <div class="tab-item" data-tab="2">Thịt</div>
                    <div class="tab-item" data-tab="3">Shasimi</div>
                    <div class="tab-item" data-tab="4">Hải sản</div>
                    <div class="tab-item" data-tab="5">Cá tươi</div>
                ...
                <div class="showtime-list show-active">
                  <div class="row">
                    ...
                    <?php foreach ($result as $row) : ?>
                      <div class="col-3 col-md-4 col-sm-4" data-item="<?php echo $row["namensx"] ?>">
                        <a href="../detail.php?id=<?php echo $row["id"] ?>" class="product-item">

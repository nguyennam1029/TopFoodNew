    ...
    <div class="container">
        <div class="nav">
            ...
            <ul class="nav-menu" id="nav-menu">
                <li><a href="./index.php" class="nav-link <?php echo ($index == "index.php" ? "active" : "") ?>">Trang Chủ</a></li>


                <li class="nav-item--type">
                    <a href="list_product.php" class="nav-link <?php echo ($product == "list_product.php" ? "active" : "") ?>">
                ...
                <li>
                    <a href="./contact.php" class="nav-link <?php echo ($contact == "contact.php" ? "active" : "") ?>">
                        Liên Hệ
                    </a>
                </li>
                ...
                <?php   } else { ?>
                    ...
                    <li>
                        <a class="avatarlink <?php echo ($user == "info_user.php" ? "active" : "") ?>" href="./info_user.php">
                    ...
                    <li>
                        <a href="view_cart2.php" class="nav-link nav-link--cart <?php echo ($cart == "view_cart2.php" ? "active" : "") ?>">

...
<body>
  <div class="app">
      ...
      <div class="hero-slide">
        <div class="owl-carousel carousel-nav-center" id="hero-carousel">
          ...
          <div class="hero-slide-item">
            <img src="https://tapchicongthuong.vn/images/19/9/19/6-mon-tuyet-doi-dung-nau-voi-thit-lon.jpg" alt="" />
    ...
    <div class="section" id="series">
      <div class="container">
        <div class="section-header">
          <p class="booton-text">Thịt bò và lợn</p>
        </div>
        <div class="movies-slide carousel-nav-center owl-carousel">
          <?php
      ...
      <div class="container">
        ...
        <div class="contact">
          <div class="contact-content">
            ...
            <a href="#" class="contact-input--submit">Liên hệ ngay</a>

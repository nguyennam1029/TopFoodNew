    ...
    *
    ...
    where oder_id = '$oder_id'";
                    ...
                    <div class="sticky-table" id="style-7">
                            ...
                            <tbody>
                                <?php foreach ($result as $each) : ?>
                                    <tr>
                                        <td>
                                            <div class="user">
                                                <img style="height: 150px;" height='100' src="../san_pham/photos/<?php echo $each['photo'] ?>">
                        ...
                        <h6 style="font-size: 20px; margin-top: 40px;">tổng tiền đơn này là <?php echo number_format($sum) ?> đ</h6>

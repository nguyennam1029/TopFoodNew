...
<body>
    ...
    <div class="container">
        ...
        <div class="main">
            ...
            <?php
            require '../connect.php';
            $sp = "SELECT COUNT(*) as 'dem' FROM products";
            $dem = mysqli_query($connect, $sp);
            $dem1 = mysqli_fetch_assoc($dem);
            $khachhang = mysqli_query($connect, "SELECT COUNT(*) as 'dem' FROM customers");
            ...
            $feedback = mysqli_query($connect, "SELECT COUNT(*) as 'dem' FROM  message "); //tạo ra 1 cột dem để ghi tổng
            $feed = mysqli_fetch_assoc($feedback); //nó trả về mảng kết hợp
            ...
            <div class="cardBox">
                <div class="card">
                    <div>
                        <div class="numbers"><?php echo $res1['dem']; ?></div>

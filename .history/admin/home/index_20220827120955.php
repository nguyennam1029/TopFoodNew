...
<body>
    ...
    <div class="container">
        ...
        <div class="main">
            ...
            // $sql_order = "SELECT status FROM oders WHERE status='1'";
            // $count = mysqli_query($connect, $sql_order);

            $donhang = mysqli_query($connect, "SELECT status FROM oders WHERE status='1'");

...
<body>
    ...
    <div class="container">
        ...
        <div class="main">
            ...
            $orders_sum = mysqli_query($connect, "SELECT SUM(*) as 'dem' FROM oders where status = 1");
            $result_orders_sum = mysqli_fetch_assoc($orders_sum);
            ...
            <div class="cardBox">
                ...
                <div class="card">
                    <div>
                        <div class="numbers"><?php echo $result_orders_sum['dem']; ?></div>

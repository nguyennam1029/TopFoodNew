...
<div class="navigation">
    <ul>
        ...
        <li class="<?= ($activePage == 'admin/home/index') ? 'active-bg' : '' ?>">
            <a href="../home/index.php" class="<?= ($activePage == 'admin/home/index') ? 'active-text' : '' ?>">
                <span class="icon">
        ...
        <li class="<?= ($activePage == 'nha_san_xuat/index') ? 'active-bg' : '' ?>">
            <a href="../nha_san_xuat/index.php" class="<?= ($activePage == 'nha_san_xuat/index') ? 'active-text' : '' ?>">
                <span class="icon">

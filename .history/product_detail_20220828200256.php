                ...
                <div class="row">
                    <div class="col-9 col-md-8 col-sm-12">
                        <div class="row product-info">
                            <div class="col-4 col-sm-12 m-o-3 col-o-3">
                            ...
                            <div class="col-8 col-sm-12">
                                <div class="moive-info">
                                    ...
                                    <ul class="list">
                                        ...
                                        <form action="./process/add_to_cart.php" method="GET">
                                            ...
                                            <li class="item list-cart">
                                                ...
                                                <?php if (!empty($_SESSION['id'])) { ?>
                                                    <p class="cart-item add-cart " style="cursor: pointer;">
                                                        <i class="fa-solid fa-cart-plus add-cart--icon"></i>
                                                        <button class="add-cart--title" style="cursor: pointer;">Thêm vào giỏ hàng </button>
                                                    </p>
                                                <?php } else { ?>

        ...
        <div class="container">
            <div class="row">
                <div class="col-4">
                    <div class="info-left">
                        ...
                        <ul class="info_left--list">
                            ...
                            <li class="info-left--item"><i class='bx bx-star'></i>
                                Theo dõi
                            </li>
                            <li class="info-left--item"><i class='bx bx-cog'></i>
                                Cài đặt
                            </li>
                            <li class="info-left--item"><i class='bx bx-bell'></i>
                                Thông báo
                            </li>
                            <li class="info-left--item">
                ...
                <div class="col-8">
                    <div class="info-form">
                        <div class="form-top">
                            <img src="./images/user-img/user.jpg" alt="">
